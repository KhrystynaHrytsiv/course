...
let diamondAce:ICard | undefined = cardDesk.find(card => card.cardSuit === 'diamond' && card.value === 'ace');
console.log(diamondAce);
let allSixth:ICard [] = cardDesk.filter(card => card.value === 6);
console.log(allSixth);
let allRed: ICard[] = cardDesk.filter(card => card.color === 'red');
console.log(allRed);
let clubs:ICard[] = cardDesk.filter(card => card.cardSuit === 'clubs');
console.log(clubs);
let spades:ICard[] = cardDesk.filter(card => card.cardSuit === 'spade' && card.value !== 6 && card.value !== 7 && card.value !== 8);
console.log(spades);