...
let users2 :IUser[] = [
    ...
    {name: 'Vasia', username: 'vaaassss', password: 'vewpds[@]'},
    {name: 'Oleh', username: 'wolf', password: 'asdvfew'},
    {name: 'Yura', username: 'zloy', password: '2345vcd'},
    {name: 'Ihor', username: 'badboy', password: 'fwefqf'},
    {name: 'Vira', username: 'virysia', password: '1qwer123'},
